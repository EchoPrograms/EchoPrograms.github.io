...
<p>I started programming with web development at seven. Since then, I've worked with software, Linux administration, networking, robotics, and embedded hardware. I use Arch and Neovim btw.</p>
